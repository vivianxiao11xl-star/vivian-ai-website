...
// Design basis: Vivian's "AI 经营家 · 启程者" certificate (Cohort 02)
  ...
  window.showWelcome = function (name) {
    ...
    wrap.innerHTML = `
      <div class="welcome-card">
        <div class="welcome-eyebrow">AI 经营家 · 启程者 · COHORT 02</div>
        <div class="welcome-name">欢迎你，${safe}</div>
        <div class="welcome-subtitle">FOUNDING FELLOW</div>
        <div class="welcome-divider"></div>
        <div class="welcome-path">驾驭者 → 启程者 → <strong>践行者 ✦</strong> → AI-Native CEO</div>
