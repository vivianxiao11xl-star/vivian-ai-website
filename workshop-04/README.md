...
- 线上路径：`/workshop-04/`
- 当前状态：Day 1 上午、下午、晚间与 Day 2 上午学习笔记均已写入；课堂网站作品展已收录 16 份在线作品；晚间 AI 员工发布会投票、结果与完整路演笔记已上线。
...
- `day2-morning.html`：已写入组织 AI 化主线、知识与 Harness、贺小波完整案例、AI 员工 3 个前提 + 3 类能力、52 项 HR 任务的流程重构与上岗四问练习；公开版已移除内部证据说明和无关对话。
