...
- 线上路径：`/workshop-04/`
- 当前状态：Day 1 上午、下午与晚间学习笔记均已写入；课堂网站作品展已收录 16 份在线作品；晚间 AI 员工发布会投票、结果与完整路演笔记已于 2026-08-22 上线。
- 后续待填：Day 2、现场照片与证书素材。
...
- `index.html`：已更新活动日期、人数、Day 1 上午／下午／晚间三篇笔记入口、作品展预览和本期连接机会。
