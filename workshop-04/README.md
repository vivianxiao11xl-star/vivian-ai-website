...
- 线上路径：`/workshop-04/`
- 当前状态：Day 1 上午、下午、晚间与 Day 2 上午、下午五篇学习笔记均已写入；课堂网站作品展已收录 16 份在线作品；晚间 AI 员工发布会投票、结果与完整路演笔记已上线。
- 后续待填：现场照片与证书素材。
...
- `day1-evening.html`：已写入财务、销售、项目管理、内容四组 AI 员工路演、现场投票、冠军项目与 Day 1 收尾公式。
- `day2-morning.html`：已写入组织 AI 化主线、知识与 Harness、贺小波完整案例、AI 员工 3 个前提 + 3 类能力、52 项 HR 任务的流程重构与上岗四问练习；公开版已移除内部证据说明和无关对话；2026-08-23 已完成桌面端、手机端与线上内容校验。
- `day2-afternoon.html`：已写入 4D AI 流利度、ISIQV、人机协作三种模式、Agent-readable 组织、五步工作流重构、人才与 KPI、组织案例、规模化边界、90 天行动及结营价值确认；公开版不含内部证据说明与私人对话。
- `galaxy.html`：已升级为 16 份课堂网站作品的综合展示页，含分类筛选、原站入口、大屏放映和现场二维码；2026-08-23 新增钟舒乔、李晔、任丁，并更正浵希与柴玮的作品署名。
- `index.html`：已更新活动日期、人数、五篇完整学习笔记入口、作品展预览和本期连接机会。
